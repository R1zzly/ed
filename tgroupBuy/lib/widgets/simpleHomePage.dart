...
import 'package:tgroupbuy/widgets/search_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        title: Column(
          children: [
            GestureDetector(
              ...
              child: Container(
                        decoration: BoxDecoration(border: Border.all(color: Colors.grey, width: 2), color: Colors.white, borderRadius: BorderRadius.all(Radius.circular(100))),
                        height: 50,
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedItemColor: const Color.fromARGB(255, 0, 90, 125),
        onTap: _onItemTapped,
      ),
    );
  }
...
//   }) : _pageViewController = pageViewController, _products = products;
